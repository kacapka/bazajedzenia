        ...
        return(
            <Fragment>
                <div className="modal_step_confirm">
                    <div className="modal_step_confirm_description">Checę dodać lokal jako:</div>
                    {_.map(data, (value, key) => (
                    key !== 'email' ?
                    <div className="modal_step_confirm_item" key={key} >
                    ...
                    <div className="modal_step_confirm_contact" key={key}>
                        <div className="modal_step_confirm_description">Jak możemy się z Tobą skontaktowac?</div>
